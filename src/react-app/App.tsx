...
function App() {
    ...
    return (
        <div style={{
            ...
            backgroundColor: showQuestions || showEmotionDialog ? "rgba(0, 0, 0, 0.5)" : "#ffffff"
        }}>
            <div style={{
                display: "flex",
                flexDirection: "column",
            ...
            {birthChakra && (
                <div>
                    {/* Блоки с серым фоном */}
                    {["birth", "today", "currentPath"].map((key, index) => (
                        <div key={index} style={{
                            backgroundColor: "#f5f5f5",
                            padding: "15px",
                            borderRadius: "8px",
                            ...
                            <p>{birthChakra[key as keyof typeof birthChakra]}</p>
