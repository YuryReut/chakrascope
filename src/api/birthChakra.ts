...
export const nakshatraToChakra = [
  1, 2, 3,  // Ашвини, Бхарани, Криттика
  5, 7, 3,  // Рохини, Мригашира, Ардра
  4, 6, 6,  // Пунавасу, Пушья, Ашлеша
  1, 2, 4,  // Магха, Пурвапхалгуни, Уттарапхалгуни
  5, 3, 6,  // Хаста, Читра, Свати
  3, 4, 1,  // Вишакха, Анурадха, Джештха
  7, 5, 7,  // Мула, Пурвашадха, Уттарашадха
  7, 5, 7   // Шравана, Дхаништха, Шатабхиша
];
